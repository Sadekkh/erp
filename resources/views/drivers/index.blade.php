        ...
        <div class="modal fade" id="customModalTwo" tabindex="-1" role="dialog" aria-labelledby="customModalTwoLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="{{ isset($edit) ? route('driver.update', $edit->id) : route('driver.store') }}" method="post">
                        @csrf
                        @if (isset($edit))
                            @method('PUT')
                        @endif
            ...
            $('.edit-garage').click(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#customModalTwoLabel').html('{{ __('messages.edit_driver') }}');
                        $('form').attr('action', '/driver/' + id);
