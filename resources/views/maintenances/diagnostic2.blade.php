...
@section('content')
    <form action="{{ route('maintenance.update', $main[0]->id) }}" method="post">
        @csrf
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                <table class="table">
                    ...
                    <tr>
                        <td>العجلات</td>
                        <td>{{ $data->number_wheels }}</td>
                    </tr>
                    <tr>
                        <td>سعة الزيت</td>
                        <td>{{ $data->oil_change }}</td>
                    </tr>
                    <tr>
                ...
                <div class="card m-0">
                    ...
                    <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectpicker" name="vehicle_id" id="vehicleSelect" data-live-search="true">
                                        @foreach ($vehicle as $b)
                                            <option data-tokens="{{ $b->name }},{{ $b->model }}" value="{{ $b->id }}">{{ $b->name }},{{ $b->model }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row gutters">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    <label for="message-text" class="col-form-label">المسافة المقطوعة</label>

                                    <input type="text" class="form-control" name="mileage" value="{{ $data->mileage }}" placeholder="المسافة المقطوعة" required="">
                                </div>
                            </div>
                        ...
                        <div class="row gutters">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    <label for="message-text" class="col-form-label">الخدمة المقترحة </label>

                                    <select class="form-control selectpicker" name="service_id" id="categorySelect" data-live-search="true">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    <label for="message-text" class="col-form-label">الحرفي </label>
