                ...
                <div class="modal-content">
                    <form action="{{ route('employee.store') }}" method="post">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="customModalTwoLabel">إضافة حرفي</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="card-body">
                                <div class="row gutters">
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="form-group">
                                            <h4>الخدمة المعين بها</h4>
                                            <select class="form-control selectpicker" name="service_id" data-live-search="true">
                                ...
                                <div class="row gutters">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="cin" placeholder="رقم الهوية" required="">
                                        </div>
                                    </div>
