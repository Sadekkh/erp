...
@section('content')
    ...
    <div class="row ">
        <div class="col"><a href="{{ route('product.create') }}"><button class="button-78" role="button">تسحيل صنف جديد</button></a></div>
        <div class="col"><a href="{{ route('stock.create') }}"><button class="button-78" role="button">إضافة إلى المخزن</button></a></div>
    ...
    {{-- <div class="row ">
        <div class="col"><a href=""><button type="button" class="btn btn-info btn-rounded">تسجيل دخول شاحنة</button></a></div>
        <div class="col"><a href=""><button type="button" class="btn btn-primary btn-rounded">تسجيل أمر صيانة</button></a></div>
        <div class="col"><a href=""><button type="button" class="btn btn-success btn-rounded">متابعة أوامر الصيانة</button></a></div>
    </div> --}}
@endsection
