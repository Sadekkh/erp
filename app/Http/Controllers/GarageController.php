...
class GarageController extends Controller
{
    ...
    {
        $data = Garage::all();
        return view('garages.index', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('garages.index'))->with('success', 'created successfully.');
    }
    ...
    public function destroy(Garage $garage)
    {
        ...
        return redirect(route('garages.index'))->with('success', 'deleted successfully.');
    }
}
